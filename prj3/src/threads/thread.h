...
struct thread
  {
    ...
    struct list child_list;             /* list to manage child processes */
    struct list_elem child_list_elem;        /* List element. */
...
/* manage file descriptor table */
   int thread_insert_file (struct file* file);
...
void thread_priority_aging (void);
void thread_priority_yield (void);
void thread_mlfqs_aging (void);
void thread_priority_clamp (struct thread *t);
